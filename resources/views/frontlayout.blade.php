...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="apple-touch-icon" href="{{ asset('asset/'.$logo->image_link2)}}" />
        <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('asset/'.$logo->image_link2)}}" />
        <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('asset/'.$logo->image_link2)}}" />
