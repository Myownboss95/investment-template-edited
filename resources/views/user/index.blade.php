      ...
      <div class="col-lg-6">
          <div class="media align-items-center ml-3">
            ...
            <div class="media-body ml-2">
              <h3 class="mb-0 h2 text-light font-weight-bolder">{{$user->first_name}} {{$user->last_name}}</h3>
              <p class="mb-1 text-light">{{__('Hi')}}, {{$user->username}} {{__('welcome to your dashboard')}}</p>
            </div>
          </div>
      </div>      
    </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-6">
                ...
                <span class="mb-0 text-light">{{$currency->symbol.number_format($user->balance)}}</span>
              </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="mb-0 text-light">{{$currency->symbol.number_format($user->profit)}}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="mb-0 text-light">{{$currency->symbol.number_format($user->total_profit)}}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="mb-0 text-light">{{$currency->symbol.number_format($user->trade_bonus)}}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          @if($set->p_inv==1)       
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="collapse show" aria-labelledby="headinTwo" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> {{__('Invest in startups and existing companies buy purchasing units.')}}</p>
          ...
          @if($set->s_inv==1)       
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headinOne" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> {{__('With our low risk plans, easy access to profit, recurring capital.')}}</p>
          ...
          @if($user->fa_status==0)
            <div class="accordion-item">
              ...
              <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> {{__('Two Factor Authentication on your account is currently disabled.')}}</p>
          ...
          @if($set->dashboard_message!=null)
            <div class="accordion-item">
              ...
              <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> {{$set->dashboard_message}}</p>
                </div>
              </div>  
            </div> 
          @endif  
            ...
            @if($user->upgrade==0)
              <div class="accordion-item">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                  <div class="card-body">
                    <p class="text-light mb-2"> {{__('You can now receive certain bonus of total profit after standard investment ends. Don\'t let your money sit there, upgrade your account & start receiving bonuses. Upgrade fee costs')}} {{$currency->symbol.$set->upgrade_fee}}</p>
          ...
          @if($set->referral==1)       
            <div class="accordion-item">
              ...
              <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> {{__('Earn money by referring family and friends to invest on')}} {{$set->site_name}}.</p>
          ...
          @if($set->savings==1)       
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headinThree" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> {{__('Let\'s run the race with you. Save and earn competitive percentage.')}}</p>
