...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-lg-10">
        <h6 class="h2 d-inline-block text-light mb-0">{{__('Disputes')}}</h6>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12 mb-5">
        <div class="text-center mt-8">
          ...
          <p class="text-dark text-sm card-text text-light">{{__('We couldn\'t find any dispute to this account')}}</p>
          <div class="row align-items-center py-4">
            <div class="col-12">
