          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="<?php echo e(route('fund.submit')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <p>Wallet ID</p>
                  <input type="text" step="any" value="<?php echo e($val->val1); ?>" class="form-control" placeholder="<?php echo e($val->val1); ?>" name="details" required readonly>
                </div>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/core/resources/views/user/fund/index.blade.php ENDPATH**/ ?>