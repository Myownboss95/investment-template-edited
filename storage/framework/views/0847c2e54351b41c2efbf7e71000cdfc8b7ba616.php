...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-4">
        <h6 class="h2 d-inline-block text-light mb-0 font-weight-bolder"><?php echo e(__('Payouts')); ?></h6>
      </div>
        ...
        <div class="row"> 
          ...
          <div class="col-md-12 mb-5">
            <div class="text-center mt-8">
              ...
              <h3 class="text-light"><?php echo e(__('No Payout')); ?></h3>
              <p class="text-light text-sm card-text"><?php echo e(__('We couldn\'t find any payouts money request to this account')); ?></p>
              <div class="row align-items-center py-4">
                <div class="col-12">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/resources/views/user/profile/withdraw.blade.php ENDPATH**/ ?>