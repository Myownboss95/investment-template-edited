          ...
          <div class="col-md-4 mb-7 mb-lg-0">
            <div data-aos="fade-up" data-aos-delay="100" class="aos-init aos-animate">
              ...
              <div class="text-center px-md-3 px-lg-7">
                ...
                <span class="text-dark font-weight-bold"><h3><?php echo e(__('About Platinum Wealth Trade')); ?></h3></span> <p class="mb-0"><?php echo e(__('Disciplined investment underwriting focused on properties below the institutional range in growing markets across the United States')); ?></p>
              </div>
              <!-- End Stats -->
            </div>
          </div>
          ...
          <div class="col-md-4 mb-7 mb-lg-0">
            <div data-aos="fade-up" class="aos-init aos-animate">
              ...
              <div class="text-center column-divider-md column-divider-20deg px-md-3 px-lg-7">
                ...
                <span class="text-dark font-weight-bold"><h3><?php echo e(__('Strategies')); ?></h3></span> <p class=" mb-0"><?php echo e(__('Platinum Wealth Trade was established with a long-term orientation to focus on value-based real estate investments with favorable risk/reward characteristics.')); ?></p>
              </div>
              <!-- End Stats -->
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div data-aos="fade-up" data-aos-delay="100" class="aos-init aos-animate">
              ...
              <div class="text-center column-divider-md column-divider-20deg px-md-3 px-lg-7">
                ...
                <span class="text-dark font-weight-bold"><h3><?php echo e(__('Portfolio')); ?></h3></span> <p class=" mb-0"><?php echo e(__('Platinum Wealth Trade and its affiliates have invested over $2.7 billion in more than 17 million square feet, including 19,000 multifamily units.')); ?></p>
              </div>
              <!-- End Stats -->
            </div>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/resources/views/front/index.blade.php ENDPATH**/ ?>