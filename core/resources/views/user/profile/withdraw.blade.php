...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-4">
        <h6 class="h2 d-inline-block text-light mb-0 font-weight-bolder">{{__('Payouts')}}</h6>
      </div>
        ...
        <div class="row"> 
          ...
          <div class="col-md-12 mb-5">
            <div class="text-center mt-8">
              ...
              <h3 class="text-light">{{__('No Payout')}}</h3>
              <p class="text-light text-sm card-text">{{__('We couldn\'t find any payouts money request to this account')}}</p>
              <div class="row align-items-center py-4">
                <div class="col-12">
