...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-12">
        <h6 class="h2 d-inline-block text-light mb-0 font-weight-bolder">{{__('Standard Investment')}}</h6>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
                  ...
                  <div class="pricing card-group flex-column flex-md-row mb-3">
                    <div class="card card-pricing border-0 text-center mb-2">
                      ...
                      <div class="card-body px-lg-7">
                        ...
                        <p class="card-text text-xs text-gray">{{__('Here a quick summary; If money invested is')}} {{$amount.$currency->name}}, {{__('ROI will be')}} {{$interest}}, {{__('Compound Interest will amount to')}} 
                        {{$compound}} {{__('after')}} {{$val->duration.' '.$val->period}}@if($val->duration>1)  @endif
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            @else
              <div class="col-md-12 mb-5">
                <div class="text-center mt-8">
                  ...
                  <p class="text-dark text-sm card-text text-light">We couldn't find any investment plans under {{$val->name}}</p>
                </div>
              </div>
            @endif
          </div>
