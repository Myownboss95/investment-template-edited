        ...
        <div class="row">  
          ...
          <div class="col-md-12 mb-5">
            <div class="text-center mt-8">
              ...
              <p class="text-dark text-sm card-text text-light">We couldn't find any transfer request to this account</p>
            </div>
          </div>
          <?php endif; ?>
        </div> 
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/core/resources/views/user/transfer/index.blade.php ENDPATH**/ ?>