...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-12">
        <h6 class="h2 d-inline-block text-light mb-0 font-weight-bolder"><?php echo e(__('Standard Investment')); ?></h6>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
                  ...
                  <div class="pricing card-group flex-column flex-md-row mb-3">
                    <div class="card card-pricing border-0 text-center mb-2">
                      ...
                      <div class="card-body px-lg-7">
                        ...
                        <div class="text-xl mb-2 text-dark"><?php echo e($currency->symbol); ?><?php echo e(number_format($val->min_deposit)); ?> - <?php echo e($currency->symbol); ?><?php echo e(number_format($val->amount)); ?> <br/><span class="text-sm text-dark">@ <?php echo e($val->percent); ?>% <?php echo e(__('Daily')); ?></span></div>
                        <p class="card-text text-sm text-dark mb-0">Runs for <?php echo e($val->duration); ?> <?php echo e($val->period); ?><?php if($val->duration>1): ?> <?php endif; ?></p>
                        <!--<p class="text-sm text-dark mb-0"><?php echo e(number_format($val->amount).$currency->name); ?> <?php echo e(__('Maximum Deposit')); ?></p>-->
                        <p class="text-sm text-dark mb-0"><?php echo e(round((($val->compound - $val->min_deposit)/$val->min_deposit)*100, 2)); ?>% <?php echo e(__('Return on Investment')); ?></p>                 
                        ...
                        <p class="card-text text-xs text-gray"><?php echo e(__('Here a quick summary; If money invested is')); ?> <?php echo e($amount.$currency->name); ?>, <?php echo e(__('ROI will be')); ?> <?php echo e($interest); ?>, <?php echo e(__('Compound Interest will amount to')); ?> 
                        <?php echo e($compound); ?> <?php echo e(__('after')); ?> <?php echo e($val->duration.' '.$val->period); ?><?php if($val->duration>1): ?>  <?php endif; ?>
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <?php else: ?>
              <div class="col-md-12 mb-5">
                <div class="text-center mt-8">
                  ...
                  <p class="text-dark text-sm card-text text-light">We couldn't find any investment plans under <?php echo e($val->name); ?></p>
                </div>
              </div>
            <?php endif; ?>
          </div>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/core/resources/views/user/trading/plans.blade.php ENDPATH**/ ?>