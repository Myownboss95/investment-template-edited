  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
            <h6 class="h2 d-inline-block text-light mb-0 font-weight-bolder"><?php echo e(__('Save Money')); ?></h6>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-5">
            <div class="text-center mt-8">
              ...
              <p class="text-dark text-sm card-text text-light">We couldn't find any saving history to this account</p>
            </div>
          </div>
          <?php endif; ?>
        </div> 
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/core/resources/views/user/savings/index.blade.php ENDPATH**/ ?>