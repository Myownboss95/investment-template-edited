      ...
      <div class="col-lg-6">
          <div class="media align-items-center ml-3">
            ...
            <div class="media-body ml-2">
              <h3 class="mb-0 h2 text-light font-weight-bolder"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h3>
              <p class="mb-1 text-light"><?php echo e(__('Hi')); ?>, <?php echo e($user->username); ?> <?php echo e(__('welcome to your dashboard')); ?></p>
            </div>
          </div>
      </div>      
    </div>
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-6">
                ...
                <span class="mb-0 text-light"><?php echo e($currency->symbol.number_format($user->balance)); ?></span>
              </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="mb-0 text-light"><?php echo e($currency->symbol.number_format($user->profit)); ?></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="mb-0 text-light"><?php echo e($currency->symbol.number_format($user->total_profit)); ?></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="mb-0 text-light"><?php echo e($currency->symbol.number_format($user->trade_bonus)); ?></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <?php if($set->p_inv==1): ?>       
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="collapse show" aria-labelledby="headinTwo" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> <?php echo e(__('Invest in startups and existing companies buy purchasing units.')); ?></p>
          ...
          <?php if($set->s_inv==1): ?>       
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headinOne" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> <?php echo e(__('With our low risk plans, easy access to profit, recurring capital.')); ?></p>
          ...
          <?php if($user->fa_status==0): ?>
            <div class="accordion-item">
              ...
              <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> <?php echo e(__('Two Factor Authentication on your account is currently disabled.')); ?></p>
          ...
          <?php if($set->dashboard_message!=null): ?>
            <div class="accordion-item">
              ...
              <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> <?php echo e($set->dashboard_message); ?></p>
                </div>
              </div>  
            </div> 
          <?php endif; ?>  
            ...
            <?php if($user->upgrade==0): ?>
              <div class="accordion-item">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                  <div class="card-body">
                    <p class="text-light mb-2"> <?php echo e(__('You can now receive certain bonus of total profit after standard investment ends. Don\'t let your money sit there, upgrade your account & start receiving bonuses. Upgrade fee costs')); ?> <?php echo e($currency->symbol.$set->upgrade_fee); ?></p>
          ...
          <?php if($set->referral==1): ?>       
            <div class="accordion-item">
              ...
              <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> <?php echo e(__('Earn money by referring family and friends to invest on')); ?> <?php echo e($set->site_name); ?>.</p>
          ...
          <?php if($set->savings==1): ?>       
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headinThree" data-parent="#accordionExample">
                <div class="card-body">
                  <p class="text-light mb-2"> <?php echo e(__('Let\'s run the race with you. Save and earn competitive percentage.')); ?></p>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Downloads/paviliumglobal/core/resources/views/user/index.blade.php ENDPATH**/ ?>